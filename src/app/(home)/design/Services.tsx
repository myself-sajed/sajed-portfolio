                    ...
                    <div className="grow space-y-3">
                        <div className="inline-flex flex-col justify-end">
                            ...
                            <span className="mt-1.5 ms-auto flex items-center gap-x-1 text-xs text-primary ">
                                <svg className="flex-shrink-0 size-3" xmlns="http://www.w3.org/2000/svg" width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
